...
class Case(object):
    ...
    def test01(self, num):
        ...
        while i < num:
            try:
                d(resourceId='com.excelliance.dualaid:id/iv_icon').click()
                d(resourceId='com.excelliance.dualaid:id/iv_back').click()
                i += 1
    ...
    def test02(self, num):
        ...
        while i < num:
            try:
                d(resourceId="com.excelliance.dualaid:id/add_but").click()
                d(resourceId="com.excelliance.dualaid:id/iv_back").click()
                i += 1
            except u2.UiObjectNotFoundError:
                print('未找到控件')
...
if __name__ == "__main__":
    ...
    run(result_path, int(input('输入各个场景的循环次数：')))
