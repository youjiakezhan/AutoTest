...
class EmailSending(object):
    ...
    def create_email(self):
        ...
        sender = username
        receiver = 'huanggao@excelliance.cn,xuhe@excelliance.cn,wangzhe@excean.com,qizhaodi@excean.com,zhuyao@excean.com, \
                   lixianzhuang@excelliance.cn,wangzhongchang@excelliance.cn'
